...
- `multorum worker outbox <worker> [--after <sequence>]` — List messages sent by a worker to the orchestrator. No lifecycle transition.
- `multorum worker inbox <worker> [--after <sequence>]` — List messages sent by the orchestrator to a worker. No lifecycle transition.
...
- `multorum local inbox [--after <sequence>]` — List messages sent by the orchestrator to this worker. No lifecycle transition.
- `multorum local outbox [--after <sequence>]` — List messages sent by this worker to the orchestrator. No lifecycle transition.
